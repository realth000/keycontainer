...
void InputInitKeyUi::keyReleaseEvent(QKeyEvent *e)
{
...
void InputInitKeyUi::initUi()
{
    ...
    this->setStyleSheet(QssInstaller::QssInstallFromFile(":/stylesheet/stylesheet_inputinitkeyui.css").arg(this->objectName()).arg("rgb(55,85,100)")
