...
#include "core/keymapjsonengine.h"
#include <QListView>
...
//    ui->mainTabWidget->setTabVisible(2, false);
    ...
    QIcon tabIco0;
    const QPixmap tab0_1 = QPixmap(":/pic/manage.png");
    const QPixmap tab0_2 = QPixmap(":/pic/manage_reverse.png");
    ...
    QIcon tabIco1;
    const QPixmap tab1_1 = QPixmap(":/pic/tools.png");
    const QPixmap tab1_2 = QPixmap(":/pic/tools_reverse.png");
    ...
    QIcon tabIco2;
    const QPixmap tab2_1 = QPixmap(":/pic/config.png");
    const QPixmap tab2_2 = QPixmap(":/pic/config_reverse.png");
    ...
    QIcon tabIco3;
    const QPixmap tab3_1 = QPixmap(":/pic/about.png");
    const QPixmap tab3_2 = QPixmap(":/pic/about_reverse.png");
    ...
    QIcon addKeyIcon;
    const QPixmap pixm1 = QPixmap(":/pic/addKey.png");
    if(!pixm1.isNull()){
    ...
    QIcon exportKeyIcon;
    const QPixmap pixm2 = QPixmap(":/pic/exportKey.png");
    if(!pixm2.isNull()){
    ...
    QIcon showKeyIcon;
    const QPixmap pixm3 = QPixmap(":/pic/showKey.png");
    if(!pixm3.isNull()){
    ...
    QIcon backupKeyIcon;
    const QPixmap pixm4 = QPixmap(":/pic/backupKey.png");
    if(!pixm4.isNull()){
    ...
    const QPixmap pixm13 = QPixmap(":/pic/backupKeys.png");
    if(!pixm13.isNull()){
    ...
    QIcon saveKeyIcon;
    const QPixmap pixm5 = QPixmap(":/pic/saveKey.png");
    if(!pixm5.isNull()){
    ...
    const QPixmap pixm6 = QPixmap(":/pic/selectInverseKey.png");
    if(!pixm6.isNull()){
    ...
    const QPixmap pixm7 = QPixmap(":/pic/selectAll.png");
    if(!pixm7.isNull()){
    ...
    const QPixmap pixm8 = QPixmap(":/pic/delKey.png");
    if(!pixm8.isNull()){
    ...
    const QPixmap pixm9 = QPixmap(":/pic/saveConfig.png");
    if(!pixm9.isNull()){
    ...
    QIcon restartIcon;
    const QPixmap pixm10 = QPixmap(":/pic/restart.png");
    if(!pixm10.isNull()){
    ...
    const QPixmap pixm11 = QPixmap(":/pic/changeInitKey.png");
    if(!pixm11.isNull()){
    ...
    const QPixmap pixm12 = QPixmap(":/pic/changeAESKey.png");
    if(!pixm12.isNull()){
    ...
    QIcon findKeyIcon;
    const QPixmap pixm14 = QPixmap(":/pic/findKey_reverse.png");
    if(!pixm14.isNull()){
    ...
    const QPixmap pixmp16 = QPixmap(":/pic/importKeys.png");
    if(!pixmp16.isNull()){
    ...
    QIcon lockAppIcon;
    const QPixmap pixmp17 = QPixmap(":/pic/lock_reverse.png");
    if(!pixmp17.isNull()){
    ...
    const QPixmap pixmp18 = QPixmap(":/pic/dice_reverse.png");
    if(!pixmp18.isNull()){
    ...
    QIcon copyGKeyIcon;
    const QPixmap pixmp19 = QPixmap(":/pic/save_reverse.png");
    if(!pixmp19.isNull()){
...
//    about_logo_pix = new QPixmap(":/pic/Key Container.jpeg");
