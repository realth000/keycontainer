...
void LogIn::initUi()
{
    ...
    this->setStyleSheet(QssInstaller::QssInstallFromFile(":/stylesheet/stylesheet_login.css").arg(this->objectName()).arg("rgb(55,85,100)")
    ...
    ui->backgroundLabel->setPixmap(QPixmap(":/pic/IconWide.png"));
    ui->lineEdit->setFocus();
    ui->logInB->setFocusPolicy(Qt::ClickFocus);

    QIcon loginIcon;
    const QPixmap pixmp1 = QPixmap(":/pic/rightArrow.png");
    if(!pixmp1.isNull()){
